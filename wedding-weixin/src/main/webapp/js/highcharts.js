(function() {
    ...
    function Gd(a, b) {
        function c(m, i) {
            ...
            var v = this,
                ...
                $ = Ga ? "x" : "y",
                oa, ua, fb, eb = z ? Y : sb,
                Ib, Tb, gc, L, ka, T, ra, Fa, Ja, Oa, fa = null,
                ca = null,
                Gb, Ld, Jd = i.minPadding,
                Kd = i.maxPadding,
                Rb = M(i.linkedTo),
                Hd, Id, Jc;
            N = i.events;
        ...
        var B = C(w.marginTop, R[0]),
            ...
            gb = w.spacingBottom,
            wb = w.spacingLeft,
            Ob, Kb, wc, ha, Hb, sb, Y, Ub, mb, Vb, ya, Pd, Uc, xc, Ya, Ua, jd, Pc, Xc, ud, vd, Yc, p = this,
            ae = (R = w.events) && !! R.click,
            wd, kc, uc, nd, bc, Sd, xd, xa, Ca, jc, Rc, Qc, od, Wb, Xb, tc, lc = w.showAxes,
            Sc = 0,
            db = [],
            Mb, Ia = [],
            qa, ga, kd, Od, ld, pd, vc, sd, td, rd, md, Td, be = function(m) {
                function i(L, ka) {
                    var T = L.legendItem,
                        ra = L.legendLine,
                        Fa = L.legendSymbol,
    ...
    var wa = document,
        ...
        Wc, Jb = wa.documentElement.ontouchstart !== undefined,
        Vd = {},
        qd = 0,
        rb = 1,
        Hc, Wa, Nc, Cc, $c, Va, Qb = "div",
        oc = "absolute",
        Qd = "relative",
        ub = "hidden",
        nc = "highcharts-",
        ...
        hb = "",
        Bb = "hover",
        Dc, bd, cd, dd, sc, Ec, Fc, Cd, Dd, ed, Ed, Fd, la = cb.HighchartsAdapter,
        Eb = la || {},
        u = Eb.each,
        yd = Eb.grep,
        mc = Eb.map,
