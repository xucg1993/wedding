...
var DWZ = {
	...
	_set:{
		...
		loginTitle:"", //if loginTitle open a adminuser dialog
		debug:false
	},
	...
	loadLogin:function(){
		if ($.pdialog && DWZ._set.loginTitle) {
			$.pdialog.open(DWZ._set.loginUrl, "adminuser", DWZ._set.loginTitle, {mask:true,width:520,height:260});
		} else {
	...
	init:function(pageFrag, options){
		var op = $.extend({
				loginUrl:"adminuser.html", loginTitle:null, callback:null, debug:false,
				statusCode:{}, keys:{}
			}, options);
